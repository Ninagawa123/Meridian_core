...
#2022.04.18 intel Mac用にdearpygui処理をmainスレッドに変更。ROSボタンはダミーのため機能なし。M1 Macではdearpyguiが未対応のため動かないはず。

# 取扱説明書
# ・起動方法
# 当ファイルがあるディレクトリにて、ターミナルより
# python3 Meridian_console_without_ros.py
    ...
    while (True):
        ...
        with closing(sock):
            while True:
                ...
                #print("[Ans ] ",r_meridim[MSG_SIZE-1])
